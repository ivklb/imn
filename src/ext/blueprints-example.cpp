    ...
    public Application
{
    ...
    ImColor GetIconColor(PinType type)
    {
        ...
        {
            default:
            case PinType::Flow:     return ImColor(255, 255, 255);  // 0xFFFFFF
            case PinType::Bool:     return ImColor(220,  48,  48);  // 0xDC3030
            case PinType::Int:      return ImColor( 68, 201, 156);  // 0x44C99C
            case PinType::Float:    return ImColor(147, 226,  74);  // 0x93E24A
            case PinType::String:   return ImColor(124,  21, 153);  // 0x7C1559
            case PinType::Object:   return ImColor( 51, 150, 215);  // 0x3396D7
            case PinType::Function: return ImColor(218,   0, 183);  // 0xFFDA00
            case PinType::Delegate: return ImColor(255,  48,  48);  // 0xFF3030
        }
    };
    ...
    void DrawPinIcon(const Pin& pin, bool connected, int alpha)
    {
        ...
        switch (pin.Type)
        {
            ...
            case PinType::Int:      iconType = IconType::Diamond; break;
            case PinType::Float:    iconType = IconType::Flow; break;
            case PinType::String:   iconType = IconType::Flow; break;
